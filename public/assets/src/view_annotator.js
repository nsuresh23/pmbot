    ...
    Annotator.Plugin.AnnotatorViewer = (function(_super) {
        ...
        AnnotatorViewer.prototype.createAnnotationPanel = function(annotation) {
            ...
            if (annonatestate != '0') {
                ...
                var EMAILID =
                    '<div class="emailticketinfo no-copy"><div class="list-group"><a class="list-group-item" href="#"><span class="badge badge-info" id="emailidcontent"></span> Reference email id </a><a class="list-group-item" href="javascript:void(0);"><div><label class="control-label">Subject:</label><textarea class="form-control email-subject" rows="5" style="padding:5px;resize:none;" readonly></textarea></div></a>' +
                    wjobid +
                    '</div></div>';
            } else {
                var annoclass = '';
                var EMAILID = '<div class="emailticketinfo"><div class="list-group"><a class="list-group-item" href="#"><span class="badge badge-info" id="emailidcontent"></span> Reference email id </a><a class="list-group-item" href="javascript:void(0);"><div><label class="control-label">Subject:</label><textarea class="form-control email-subject" rows="5" style="padding:5px;resize:none;" readonly></textarea></div></a><a class="list-group-item" href="javascript:;"><button type="button" class="btn btn-primary btn-sm"  id="Myisbnbtn" onclick="Myisbnbtnfrm()">Add JOB</button><button type="button" class="btn btn-success btn-sm" style="margin-left: 15px;" id="generic-btn" onclick="genericBtnFrm()">Generic</button><div class="modal-content" id="createisbnfrm"><div class="modal-body"><div class="row"><div class="col-md-12"><div class="form-group no-margin"><input type="text" class="form-control" id="isbn" pattern="[/\w/\s-]+" title="{{ __("job.job_isbn_match_error_msg") }}" placeholder="Enter your job"><button type="button" class="btn btn-info btn-sm" id="insertisbn" onclick="saveisbntodb()">Save</button></div></div></div></div></div><div class="modal-content" id="create-generic-job-frm" style="display:none;"> <div class="modal-body"> <div class="row"> <div class="col-md-12"> <div class="form-group no-margin"><input type="text" class="form-control" id="generic-job-title" placeholder="Enter job title"><button type="button" class="btn btn-info btn-sm" id="insert-generic-job" onclick="saveGenericToDB()" style="margin-top:5px;">Save</button></div> </div> </div> </div> </div></a><a class="list-group-item email-classification-category-block">Email classification category: <div class="select-wrapper" style="margin-top: 5px;"><select class="select2 email-classification-category-list"></select></div></a><a class="list-group-item">JOB <div class="select-wrapper" style="margin-top: 5px;"><span id="pmjobIDlist"></span></div></a><a class="list-group-item" href="javascript:;"><button type="button" class="btn btn-info" id="btnannatorcompleted" onclick="annotatorcompleted()" style="display:none;">Completed</button></a></div></div>';
            }
