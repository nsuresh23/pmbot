...
!function () {
	...
	Annotator = function (_super) {
			...
			this.viewer.hide().on("edit", this.onEditAnnotation).on("delete", this.onDeleteAnnotation).addField({
				load: function (_this) {
					return function (field, annotation) {
						...
						if(annotation.section_title == null){ annotation.section_title = annotation.tasktitle;} 
						
						if (annotation.section_title) {
							$(field).html(Util.escape(annotation.section_title))
						} else {
							$(field).html("<i>" + _t("No Labels") + "</i>")
						}
		...
		Annotator.prototype.setupAnnotation = function (annotation) {
			...
			$('#annotationdescription').html(annotation.quote);
		...
		Annotator.prototype.deleteAnnotation = function (annotation) {
			...
			if (annotation.highlights != null) {
				...
				annotation.tasktitle = null;
				annotation.taskdesc = null;
				annotation.tasknotes = null;
	...
	Annotator.Editor = function (_super) {
		...
		Editor.prototype.addField = function (options) {
			...
			input = null;
			element = $('<li class="annotator-item last" />');
				...
				return function (event) {
					...
					if (mousedown && throttle === false) {
						...
						if (mousedown.element === resize[0]) {
							height = textarea.outerHeight()+100;
	...
	Annotator.Plugin.Store = function (_super) {
		...
		Store.prototype._apiRequestOptions = function (action, obj, onSuccess) {
			...
			obj.page = document.getElementById("emailid").value;	
	...
	Annotator.Plugin.Filter = function (_super) {
		...
		Filter.prototype._onFilterFocus = function (event) {
			var input;
			input = $(event.target);
			input.parent().addClass(this.classes.activewwww);
