                    ...
                    <form class="email-rating-form" action="{{ $emailRatingUrl ?? '#' }}">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <div class="form-group mb-0">
                                ...
                                <input name="language" value="" data-size="sm" title="" class="star-block rating-loading language">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <div class="form-group mb-0">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0 reviewed-by-block display-none">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                                <div class="form-group mb-0">
                                    <span class="txt-blue reviewer-name font-16"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                                <div class="form-group mb-0">
                                    <span class="txt-dark reviewed-date font-12"></span>
                                </div>
                            </div>
                        </div>
                    </form>
