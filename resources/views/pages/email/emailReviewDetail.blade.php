                    ...
                    <form class="email-rating-form" action="{{ $emailRatingUrl ?? '#' }}">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <div class="form-group mb-0">
                                ...
                                <input name="greetings" value="2" data-size="sm" title="" class="star-block rating-loading greetings">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <div class="form-group mb-0">
                                <span class="txt-dark rating-label">Language used in communication:</span>
                                <input name="effectiveness" value="2" data-size="sm" title="" class="star-block rating-loading effectiveness">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <div class="form-group mb-0">
                                <span class="txt-dark rating-label">Satisfaction of the affected stakeholder:</span>
                                <input name="format" value="2" data-size="sm" title="" class="star-block rating-loading format">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <hr class="light-grey-hr mt-5 mb-5">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0">
                            <div class="form-group mb-0">
                                ...
                                <input name="assertiveness" value="2" data-size="sm" title="" class="star-block rating-loading assertiveness">
                            </div>
                        </div>
