<aside class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pr-0">
    ...
    <ul class="inbox-nav mb-30">
        <li class="active">
            <a class="dashboard-inbox-email" href="javascript:void(0);">
        ...
        <li class="">
            <a class="dashboard-outbox-email" href="javascript:void(0);">
                <i class="zmdi zmdi-email-open"></i>
                {{ __("job.email_outbox_mail_label") }}
            </a>
        </li>
        <li class="">
            <a class="dashboard-sent-email" href="javascript:void(0);">
                <i class="zmdi zmdi-email-open"></i>
                {{ __("job.email_sent_mail_label") }}
            </a>
        </li>
        <li class="">
            <a class="dashboard-draft-email" href="javascript:void(0);">
