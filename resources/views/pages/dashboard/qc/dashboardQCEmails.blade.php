    ...
    <div class="row">
        ...
        <aside class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inbox-body email-list-body pa-0">
                <div id="qcEmail" class="myEmailGrid emailGrid tab-pane fade pt-0 active in" data-category="qcEmail"
                    data-type="dashboard" data-email-filter="qc_email" data-list-url="{{ $myEmailListUrl }}"
