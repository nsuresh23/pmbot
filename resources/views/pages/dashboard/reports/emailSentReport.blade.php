<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pa-0 pb-5 border-block">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-5 pr-5">
        ...
        <table id="sent-email-report-grid" class="sent-email-report-grid table table-striped table-bordered nowrap ma-0 wd-100" data-type="dashboard" data-category="sent_email" data-list-url="{{ $sentEmailReportListUrl }}" data-current-route="{{ $currentRoute }}">
