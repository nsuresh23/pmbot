                                ...
                                <div class="col-sm-12 nopadding">
                                    ...
                                    <div class="email-rt">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="reply_cc">
                                                <input type="text" placeholder="" id="email-reply-cc" name="cc"
                                                    class="form-control email-reply-cc" autocomplete="off">
                                                <input type="hidden" placeholder="" id="replycc_value"
                                                    class="form-control email-reply-cc" value="">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="reply_bcc">
                                                ...
                                                <input type="hidden" placeholder="" id="replybcc_value"
                                                    class="form-control email-reply-bcc" value="">
                                        ...
                                        <div class="box">
                                            ...
                                            <input type="file" class="form-control replyattachements fileupload"
                                                name="attachement" multiple="multiple">
                                        </div>
                                        {{-- <div class="box">
                                            <div class="email-label border-none sig_change"
                                                data-signature-geturl="{{ $getSignatureUrl ?? '#'}}">
                                            </div>
                                            <select style="width:20% !important;" class="form-control signature_change"
                                                name="signature" data-signature-type="reply">
