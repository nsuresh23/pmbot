                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="username"
                                            ...
                                            placeholder="{{ __('auth.loginUserNamePlaceHolder') }}">
                                        @error('username')
                                    ...
                                    <div class="form-group">
                                        <label class="pull-left control-label mb-10" for="{{ __('auth.loginPasswordLabel') }}">
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-primary  btn-rounded">{{ __('auth.loginButton') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
