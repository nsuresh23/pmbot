...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        $tableNames = ['users' => 'users', 'roles' => 'roles', 'permissions' => 'permissions', 'user_has_permissions' => 'user_has_permissions', 'user_has_roles' => 'user_has_roles', 'role_has_permissions' => 'role_has_permissions'];
        $foreignKeys = ['users' => 'user_id'];
